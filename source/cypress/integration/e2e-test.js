...
describe('Tests for status text', () => {
    beforeEach(() => {
        cy.visit('index.html');
        cy.get("#options-btn").click();
        cy.get("#pom-length").clear().type("1");
    ...
    it('Default is stopped', () => {
        cy.get("#pomodoro-state-text").should("contain.text", "Stopped");
    });

    it('Working session', () => {
        cy.get("#start").click();
        cy.tick(1000);
        cy.get("#pomodoro-state-text").should("contain.text", "Work");
    });
    ...
    it('Short break session', () => {
        ...
        cy.tick(1000);
        cy.get("#pomodoro-state-text").should("contain.text", "Short Break");
    });
    ...
    it('Long break session', () => {
        ...
        cy.tick(1000);
        cy.get("#pomodoro-state-text").should("contain.text", "Long Break");
    });
...
describe('Tests for task list', () => {
    ...
    //     cy.get("#project-list").should("have.length", 3);
    //     cy.get("#project-list").eq(0).should("contain.text", "Test1");
    //     cy.get("#project-list").eq(1).should("contain.text", "Test2");
    //     cy.get("#project-list").eq(2).should("contain.text", "Test3");
    // });
